...
<div class="sign-in-container">
      <form class="sign-in-block" method="post" action="./check_sign_up.php">
        ...
        <div class="firstname-block form-control">
            ...
            <input type="text" class="firstname-field" placeholder="FirstName" name="first_name">
        </div>
        <div class="lastname-block form-control">
            <label for="">LastName</label>
            <input type="text" class="lastname-field" placeholder="LastName" name="last_name">
        </div>
        ...
        <div class="phone-block form-control">
            ...
            <input type="text" class="phone-field" placeholder="Phone Number" name="phone">
        </div>
        <div class="password-block form-control">
            <label for="">Password</label>
            <input type="password" class="password-field" placeholder="Create Password" name="password">
        </div>
        <div class="password-block form-control">
            <label for="">Password</label>
            <input type="password" class="password-field" placeholder="Confirm Password" name="confirm_password">
        </div>
