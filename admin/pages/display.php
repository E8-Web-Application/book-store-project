...
<div class="table-container">
   ...
   <div class="table">
      ...
      $sql = "SELECT product.id as id,product.name as name,product.image as image,category.category_name as category_name,product.price as price FROM `product` INNER JOIN `category` ON product.category_id=category.id LIMIT $start_limit,
      $results_per_page";
   ...
   <div class="display-pagination">
      ...
      for ($i = 1; $i <= $total_pages; $i++) {
         echo "<a href='./display.php?page=$i&&search=$search_name'>$i</a> ";
      }
      ?>
   </div>
